...
<body>
	...
	<p>
		...
		<br>
		<textarea name="data" cols="50" rows="10" placeholder="This is the file you can use to provide input to your program and later on open it inside your program to process the input."></textarea>
		<br>
